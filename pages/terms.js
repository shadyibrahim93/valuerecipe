  ...
  return (
    <div className='vr-legal-page'>
      <div className='vr-legal-container'>
        ...
        <h2>1. About ValueRecipe</h2>
        <p>
          ValueRecipe (“we,” “our,” “us”) operates as an online recipe and
        ...
        <h2>2. Eligibility</h2>
        <p>
          Anyone may view ValueRecipe. To create an account, save favorites,
        ...
        <p>
          If you create an account on ValueRecipe, you agree to provide accurate
        ...
        <p>
          ...
          all other content on ValueRecipe are owned exclusively by ValueRecipe
        ...
        <p>
          ...
          content. By submitting any content, you grant ValueRecipe a
        ...
        <p>
          ...
          infringe on the intellectual property rights of others. ValueRecipe
          reserves the right to remove or moderate any submitted content.
        </p>

        <h2>6. Disclaimer: Allergies, Nutrition, and Recipe Outcomes</h2>
        <p>
          ValueRecipe provides recipes for informational and entertainment
        ...
        <p>
          ValueRecipe may update or modify recipes, instructions, images, or
        ...
        <ul>
          ...
          <li>Copy or republish ValueRecipe content elsewhere</li>
        ...
        <p>
          Sharing links to ValueRecipe recipes is allowed and encouraged as part
          of normal, acceptable use.
        </p>

        <h2>9. Advertising, Sponsors, and Affiliate Links</h2>
        <p>
          ValueRecipe displays advertising and may include sponsored content,
          brand partnerships, and affiliate links. When affiliate links are
          used, ValueRecipe may earn a commission at no additional cost to the
          user. Sponsored posts will be clearly disclosed.
        </p>
        ...
        <p>
          We may suspend or terminate your account or access to ValueRecipe if
        ...
        <p>
          To the fullest extent allowed by law, ValueRecipe is not liable for
        ...
        <p>
          We may update these Terms periodically. Continued use of ValueRecipe
